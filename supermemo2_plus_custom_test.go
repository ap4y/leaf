...
func TestRecord(t *testing.T) {
	results := [][]float64{
		...
		{0.43, 0.87, 1.68, 3.08, 5.37, 8.89, 13.94, 20.63, 28.69},
		{0.46, 1.04, 2.39, 5.57, 13.15, 31.51, 76.56, 188.6, 300},
	}
	...
	t.Run("sequence", func(t *testing.T) {
		...
		assert.InDeltaSlice(t, []float64{0.46, 1.04, 2.39, 5.57, 1, 2.24}, intervals, 0.01)
		...
		assert.InDeltaSlice(t, []float64{0.2, 0.46, 1.04, 2.39, 5.57, 1}, historical, 0.01)
	})
}
